...
SimpleNet outperforms deeper andheavier architectures such as AlexNet, VGGNet,ResNet,GoogleNet,etc in a series of benchmark datasets, such as CIFAR10/100, MNIST, SVHN. 
It also achievs a higher accuracy (currently 60.88/83.46) in imagenet, more than AlexNet, NIN, Squeezenet, etc with only 5.4M parameters.
